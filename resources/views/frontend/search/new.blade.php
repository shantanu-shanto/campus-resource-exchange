{{-- resources/views/frontend/search/new.blade.php --}}
@extends('layouts.app')
...
<div class="container py-4">
    ...
    <div style="margin-bottom: 32px;">
        ...
        <p class="text-muted">Recently added items on campus</p>
    </div>

    {{-- Days Filter --}}
    <div class="row mb-4">
        <div class="col-md-4">
            <form method="GET" action="{{ route('frontend.search.new') }}" class="d-flex gap-2">
                <select name="days" class="form-select" style="max-width: 200px;">
        ...
        <div class="card">
            <div class="card-body text-center py-5">
                ...
                <p class="text-muted mb-4">
                    Try expanding the time range or check back later.
                </p>
