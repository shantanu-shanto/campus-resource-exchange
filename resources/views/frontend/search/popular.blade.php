{{-- resources/views/frontend/search/popular.blade.php --}}
@extends('layouts.app')
...
<div class="container py-4">
    ...
    <div style="margin-bottom: 32px;">
        <h1 class="page-title">Popular Items</h1>
        <p class="text-muted">Most requested and highest rated items on campus</p>
    </div>

    {{-- Timeframe Filter --}}
    <div class="row mb-4">
        <div class="col-md-4">
            <form method="GET" action="{{ route('frontend.search.popular') }}" class="d-flex gap-2">
                <select name="timeframe" class="form-select" style="max-width: 200px;">
                    ...
                    <option value="365" {{ $timeframe == 365 ? 'selected' : '' }}>This year</option>
                </select>
        ...
        <div class="card">
            <div class="card-body text-center py-5">
                ...
                <p class="text-muted mb-4">
                    Try expanding the timeframe or check back later.
                </p>
