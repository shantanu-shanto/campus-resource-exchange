...
@section('title', 'Borrowing History - Campus Resource Exchange')
...
<div class="container mt-5">
    <div class="mb-4 d-flex justify-content-between align-items-center">
        <div>
            <h2><i class="bi bi-box-arrow-in-down"></i> Borrowing History</h2>
            <p class="text-muted">All items you have borrowed and completed</p>
        </div>
    ...
    @else
        <div class="alert alert-info text-center" role="alert">
            ...
            <p class="text-muted mb-0 mt-1">Items you borrow and return will appear here.</p>
        </div>
    @endif
</div>
